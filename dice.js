...
hold.addEventListener('click',function(e){
    if(playing){
        document.getElementById(`score--${activeplayer-1}`).textContent =Number( document.getElementById(`score--${activeplayer-1}`).textContent)+currentscore;
    if(document.getElementById(`score--${activeplayer-1}`).textContent>=10){
        playing=false;
